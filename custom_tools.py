import json
from adk.agent import Tool

class BudgetTools:
    """
    A set of custom tools for performing deterministic financial validation.
    Used by the Aggregator Agent to finalize gift selection. This is "Santa's Secret Budget Tool."
    """

    @Tool
    def check_budget_compliance(self, gift_price: float, recipient_budget: float, currency: str) -> str:
        """
